...
class InterruptionsController extends Controller {

    private $viewFolder = "interruptions";
    ...
    {
        $classvar = new Interruptions($this->db);
        $this->f3->set('sqldata',$classvar->all($this->f3->get('SESSION.company')));
        $this->f3->set('section','interruptions');
        $this->f3->set('subnav','true');
        $this->f3->set('back','no');
        $this->f3->set('backto','interruptions');
